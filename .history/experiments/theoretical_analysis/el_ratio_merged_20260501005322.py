...
# ADD after the to_np function:

def get_normalization_scales(model, t_list, T, BC, obs, obstacle_type):
    """
    Replicates the epoch-0 normalization from train_model.
    Returns scale_phy, scale_obs, scale_v, scale_omega.
    """
    with torch.no_grad():
