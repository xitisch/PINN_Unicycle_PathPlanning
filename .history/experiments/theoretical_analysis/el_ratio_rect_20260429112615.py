...
output_folder = os.path.join("results", "el_verification", "rectangle")
...
def main():
    ...
    #    lambda_v * v = lambda_phy * (r_x cos(theta) + r_y sin(theta))
    # ============================================================
    lhs_v = lambda_v * v
    ...
    # ============================================================
    # 3) Angular equation:
    #    lambda_omega / lambda_phy = r_theta / omega
    #    Also plot LHS and RHS separately
    # ============================================================
    lhs_theta = lambda_omega * omega
