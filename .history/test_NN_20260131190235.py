...
# Training setup: repeateldly adjusting the NN's parameters so that its output trajectory satisfies physics, BC, and constraints by minimizing loss functions.
